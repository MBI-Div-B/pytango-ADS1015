...
class ADS1015tango(Device):
    ...
    def read_ADC0(self):
        return self.__ads1015.get_compensated_voltage(channel='in0/in3', reference_voltage=self.__reference)
    
    @command (dtype_out='float')  
    def read_ADC1(self):
        return self.__ads1015.get_compensated_voltage(channel='in1/in3', reference_voltage=self.__reference)
                           

def main(args=None, **kwargs):
    """Main function of the ADS1015tango module."""
    return run((ADS1015tango,), args=args, **kwargs)
